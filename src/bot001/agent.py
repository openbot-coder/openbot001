...
class Agent:
    ...
    def run(self, session_id: str, user_message: str) -> str:
        ...
        self.session_manager.save_message(session_id, user_msg)
        ...
        for turn in range(self.config.max_turns):
            ...
            # 保存到会话
            self.session_manager.save_message(session_id, assistant_msg)
            ...
            for tc in tool_calls:
                ...
                self.session_manager.save_message(session_id, tool_msg)
                messages.append({
                    "role": "tool",
                    "content": result.content,
                    "tool_call_id": call_id,
